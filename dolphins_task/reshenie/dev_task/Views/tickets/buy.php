...
<body>
    ...
    <div class="bg-container">
        <div id="video-container">
            <video src="../Views/vid/background-video.mp4" preload="auto" autoplay="" type="video/mp4" loop></video>
        </div>
                ...
                <div class="input-section">
                    <div class="top-input-fields">
                        ...
                        <div class="input-data user-inp">
                            ...
                            <div class="input-icon">
                                <!-- <input type="text" id="time" name="time-visit"/> -->
                    ...
                    <div class="agree-section">
                        <label class="check-btn-container">
                            <input type="radio" onclick="toggleCheck(this)" name="terms-agree">
                    ...
                    <div class="bottom-btn">
                        ...
                        <div class="input-data">
                            <input type="submit" value="Към плащане" name="pay">
                        </div>
